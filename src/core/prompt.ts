 ...
 */
export function buildSystemPrompt(cwd: string, repoMap = ""): string {
  // Repo-map is appended LAST so the static part of the prompt stays a stable
  // cache prefix even when the map changes between sessions.
